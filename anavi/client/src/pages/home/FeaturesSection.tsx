...
import { Card3D } from "@/components/PremiumAnimations";
          ...
          {[
            {
              ...
              description:
                "Automatically extract deals, action items, and connections from your Fireflies transcripts.",
            ...
            },
            {
              ...
              description:
                "Visualize your entire network with Obsidian-style graph views showing all relationships.",
            ...
            },
            {
              ...
              description:
                "Access exclusive, vetted opportunities with full thesis, risk disclosure, and operator backgrounds.",
              link: "/deal-rooms",
            },
            {
              icon: Building2,
              title: "SPV Generator",
              description:
                "Launch compliant investment vehicles in minutes with automated legal structure generation.",
              link: "/spv-generator",
            },
            {
              icon: TrendingUp,
              ...
              description:
                "Track commitments, manage capital calls, and visualize cap tables in real-time.",
            ...
            },
            {
              ...
              description:
                "Immutable audit logs, KYC verification, and regulatory compliance workflows.",
              link: "/audit-logs",
            },
          ].map((feature, i) => (
              ...
              <Card3D intensity={8} glare={true}>
                <motion.div
                  ...
                  whileHover={{
                    y: -4,
                    boxShadow:
                      "0 20px 60px rgb(0 0 0 / 0.28), 0 0 40px oklch(0.75 0.18 200 / 0.12)",
                  }}
                ...
                >
                  ...
                  <h3 className="text-xl md:text-2xl font-medium text-white mb-3 md:mb-4 relative z-10">
                    {feature.title}
                  </h3>
                  <p className="text-sm md:text-base text-white/60 leading-relaxed relative z-10">
                    {feature.description}
                  </p>
                  <motion.div
