...
export function HowItWorksSection() {
  return (
    <section
      id="how-it-works"
      className="py-24 md:py-32 bg-canvas-deep relative overflow-hidden"
    >
      <MorphingBlob
        className="w-[500px] h-[500px] top-[20%] -right-[150px]"
        color="oklch(0.72 0.14 70 / 0.08)"
      />
          ...
          {[
            {
              step: "01",
              title: "Connect",
              desc: "Sync your Fireflies, calendar, and CRM to import your network automatically.",
            },
            {
              step: "02",
              title: "Analyze",
              desc: "AI extracts deals, relationships, and action items from your conversations.",
            },
            {
              step: "03",
              title: "Match",
              desc: "Get matched with opportunities based on your network and expertise.",
            },
            {
              step: "04",
              title: "Close",
              desc: "Execute deals with compliant SPVs, capital management, and audit trails.",
            },
          ].map((item, i) => (
