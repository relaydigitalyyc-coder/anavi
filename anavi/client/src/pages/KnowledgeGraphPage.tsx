...
const sampleNodes: GraphNode[] = [
  ...
  {
    id: "person-8",
    label: "Veronica Welch",
    type: "person",
    data: {
      role: "Strategy",
      actionItems: ["Review model profiles", "Prepare proposal deck"],
    },
  },
  ...
  {
    id: "company-1",
    label: "Nova Talent Corp",
    type: "company",
    data: {
      description:
        "Holding company for fintech, healthcare, and media ventures",
      revenue: "$10M/month",
    },
  },
  {
  ...
  {
    id: "action-1",
    label: "Mobile Demo Optimization",
    type: "action",
    data: {
  ...
  {
    id: "action-3",
    label: "Peptide Production Setup",
    type: "action",
    data: {
      assignee: "Shane Fox",
      priority: "Medium",
...
const actionItems = [
  ...
  {
    id: 6,
    task: "Set up phone controller system",
    assignee: "Dug Dugmor",
    meeting: "VA Phone Control",
    priority: "High",
    status: "In Progress",
    dueDate: "2026-01-18",
  },
  {
    id: 7,
    task: "Provide licensing options",
    assignee: "Dug Dugmor",
    meeting: "VA Phone Control",
    priority: "Medium",
    status: "Done",
  ...
  {
    id: 8,
    task: "Review device list and pricing",
    assignee: "Dan",
    meeting: "Snapchat Demo",
    priority: "High",
    status: "Pending",
    dueDate: "2026-01-18",
  },
...
const meetingInsights = [
  {
    ...
    summary:
      "Strategic plan to launch healthcare division with peptide therapies and fintech ecosystem for asset tokenization.",
    sentiment: "Positive",
    actionCount: 15,
  },
  {
    ...
    summary:
      "Multi-VA remote phone control system setup with Rust Desk for managing 15 phones from one computer.",
    sentiment: "Neutral",
    actionCount: 6,
  },
  {
    ...
    summary:
      "$40,000 setup fee for 20 iPhone remote management system via AnyDesk.",
    sentiment: "Positive",
    actionCount: 5,
  },
];
...
export default function KnowledgeGraphPage() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = trpc.knowledgeGraph.graphData.useQuery(undefined, { retry: false });
  ...
  const mergedLinks = [...backendLinks, ...sampleLinks];

  const handleNodeClick = (_node: GraphNode) => {};

  const handleNodeDoubleClick = (_node: GraphNode) => {};
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Obsidian-style visualization of your CRM relationships and
                meeting insights
              </p>
            </div>
                ...
                {selectedMeeting ? (
                  <Card className="border-0 shadow-lg">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div>
                        <h4 className="font-medium text-sm mb-2">
                          Action Items ({selectedMeeting.actionCount})
                        </h4>
