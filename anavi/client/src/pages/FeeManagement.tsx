...
// ─── DEMO DATA ──────────────────────────────────────────────────────────────
// @backlog Wire to live tRPC queries when fee schema is finalised.
...
export default function FeeManagement() {
  ...
  const activeFeeStats = capabilities.allowDemoFixtures
    ? feeStats
    : EMPTY_FEE_STATS;
  const activeFeeStructure = capabilities.allowDemoFixtures
    ? feeStructure
    : {
        managementFee: 0,
        carryFee: 0,
  ...
  const activePartnerPayouts = capabilities.allowDemoFixtures
    ? partnerPayouts
    : [];
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {formatCurrency(activeFeeStats.totalRevenue)}
                </p>
              </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {formatCurrency(activeFeeStats.managementFees)}
                </p>
              </div>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {activeFeeStructure.managementFee}% of AUM
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {formatCurrency(activeFeeStats.carryFees)}
                </p>
              </div>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {activeFeeStructure.carryFee}% above {activeFeeStructure.hurdle}%
              hurdle
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {formatCurrency(activeFeeStats.transactionFees)}
                </p>
              </div>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {activeFeeStructure.transactionFee}% per transaction
            </p>
          </CardContent>
        </Card>
      </div>
                ...
                <Table className="w-full">
                  <TableHeader>
                    <TableRow className="border-b">
                      <TableHead className="text-left p-4 text-sm font-medium text-muted-foreground">
                        Type
                      </TableHead>
                      <TableHead className="text-left p-4 text-sm font-medium text-muted-foreground">
                        Source
                      </TableHead>
                      <TableHead className="text-right p-4 text-sm font-medium text-muted-foreground">
                        Amount
                      </TableHead>
                      <TableHead className="text-right p-4 text-sm font-medium text-muted-foreground">
                        Date
                  ...
                  <TableBody>
                    {recentFees.map(fee => (
                      ...
                      >
                        ...
                        <TableCell className="p-4 text-right font-mono font-medium">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                ...
                <span className="font-bold">
                  {activeFeeStructure.managementFee}%
                </span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                <span className="text-sm">Carry (Performance)</span>
                <span className="font-bold">
                  {activeFeeStructure.carryFee}%
                </span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                <span className="text-sm">Hurdle Rate</span>
                <span className="font-bold">{activeFeeStructure.hurdle}%</span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                <span className="text-sm">Transaction Fee</span>
                <span className="font-bold">
                  {activeFeeStructure.transactionFee}%
                </span>
              </div>
              <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                <span className="text-sm">Finder Fee</span>
                <span className="font-bold">
                  {activeFeeStructure.finderFee}%
                </span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {(
                      (activeFeeStats.managementFees /
                        activeFeeStats.totalRevenue) *
                      100
                    ).toFixed(1)}
                    %
                  </span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {(
                      (activeFeeStats.carryFees / activeFeeStats.totalRevenue) *
                      100
                    ).toFixed(1)}
                    %
                  </span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {(
                      (activeFeeStats.transactionFees /
                        activeFeeStats.totalRevenue) *
                      100
                    ).toFixed(1)}
                    %
              ...
              <div className="space-y-2">
                ...
                <Progress
                  value={
                    (activeFeeStats.finderFees / activeFeeStats.totalRevenue) *
                    100
                  }
                  className="h-2"
                />
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {activePartnerPayouts.map(payout => (
                <div
                  key={payout.id}
