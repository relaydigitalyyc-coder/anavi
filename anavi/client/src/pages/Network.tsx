...
export default function Network() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = trpc.relationship.getNetwork.useQuery(undefined, { retry: false });
  ...
  const statCards = [
    ...
    { label: "Communities", value: stats?.stats?.clusters || 0, icon: Layers },
    {
      ...
      value: stats?.stats?.avgDegree?.toFixed(1) || 0,
      icon: NetworkIcon,
    },
  ];
              ...
              <div className="space-y-5">
                <div>
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="font-semibold">
                      {((stats?.stats?.density || 0) * 100).toFixed(1)}%
                    </span>
                  </div>
                  <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(stats?.stats?.density || 0) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="font-semibold">
                      {((stats?.stats?.clustering || 0) * 100).toFixed(1)}%
                    </span>
                  </div>
                  <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(stats?.stats?.clustering || 0) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="font-semibold">
                      {((stats?.stats?.centrality || 0) * 100).toFixed(1)}%
                    </span>
                  </div>
                  <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(stats?.stats?.centrality || 0) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-medium">
                            {connector.name || `User ${connector.id}`}
                          </span>
                        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-primary-foreground/70 leading-relaxed">
                  Your network shows strong clustering patterns with potential
                  for expansion. Consider leveraging your top connectors to
                  access new communities and strengthen your position as a key
