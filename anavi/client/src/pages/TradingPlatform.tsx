...
export default function TradingPlatform() {
  ...
  const demoFallback = capabilities.allowDemoFixtures;
  const portfolioStats = {
    totalValue: totalValue || (demoFallback ? 75000000 : 0),
    weeklyReturn: demoFallback ? 20.4 : 0,
    monthlyReturn: demoFallback ? 87.2 : 0,
    ytdReturn: demoFallback ? 342.8 : 0,
    allocatedCapital: demoFallback ? 100000000 : 0,
    availableCapital: demoFallback ? 25000000 : 0,
    activePositions: positions.length,
    pendingOrders: demoFallback ? 3 : 0,
  };
  const activeRecentTrades = demoFallback ? recentTrades : [];
  const activeAllocationBreakdown = demoFallback ? allocationBreakdown : [];
  const activeWeeklyPerformance = demoFallback ? weeklyPerformance : [];
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="mt-2">
              ...
              <Progress
                value={(portfolioStats.weeklyReturn / 20) * 100}
                className="h-1.5"
              />
            </div>
          </CardContent>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {formatCurrency(portfolioStats.availableCapital)}
                </p>
              </div>
                        ...
                        {positions.map(position => (
                          ...
                          >
                            ...
                            <TableCell className="p-4 text-right">
                              ...
                              <div
                                className={`text-xs ${position.pnlPercent >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {activeWeeklyPerformance.map((week, idx) => (
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {activeAllocationBreakdown.map((item, idx) => (
                <div key={idx} className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
