...
const pendingActions = [
  ...
  },
  {
    id: 2,
    type: "document",
    spv: "TechGrowth Partners II",
    document: "Q4 2025 Report",
    action: "Review",
  },
  {
    id: 3,
    type: "signature",
    spv: "Meridian Real Estate Fund",
...
const documents = [
  {
    id: 1,
    name: "Subscription Agreement - Acme Ventures",
    type: "Legal",
    date: "2024-03-15",
    signed: true,
  },
...
export default function LPPortal() {
  ...
  const investments = lpData?.commitments?.length
    ? lpData.commitments.map((c: any) => ({
        ...
        currentValue:
          Number(c.amountFunded ?? 0) + Number(c.totalDistributions ?? 0),
        status: c.status,
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className="gap-1 py-1.5 px-3 border-green-500 text-green-500"
          >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium">
                    You have {pendingActions.length} pending actions
                  </span>
                </div>
      ...
      <div className="grid grid-cols-6 gap-4 mb-8">
        ...
        <Card className="col-span-1">
          <CardContent className="pt-6">
            ...
            <div className="text-2xl font-bold">{portfolioSummary.moic}x</div>
          </CardContent>
        </Card>
      </div>
            ...
            <div className="col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Your current portfolio allocations
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {investments.map(inv => (
                      ...
                      >
                        ...
                        <TableCell className="py-4 px-4 text-right font-mono">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {((inv.called / inv.committed) * 100).toFixed(0)}%
                            called
                          </div>
                        </TableCell>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Legal documents, reports, and notices
                  </CardDescription>
                </div>
        ...
        <TabsContent value="capital-calls">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your capital call obligations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your investor accreditation details
                </CardDescription>
              </CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="capitalize">
                      {accreditationStatus.method.replace("_", " ")}
                    </span>
                  </div>
                </div>
