...
function getEntityIcon(entityType: string) {
  ...
  if (t.includes("deal") || t.includes("match"))
    return <Activity className="h-4 w-4" />;
  if (t.includes("user") || t.includes("profile"))
    return <User className="h-4 w-4" />;
  if (t.includes("document") || t.includes("intent"))
                    ...
                    {filteredItems.map((log, index) => (
                      ...
                      >
                        ...
                        <TableCell className="py-4 px-4">
                          {log.hash ? (
                            <code
                              className="text-[10px] font-mono text-muted-foreground block max-w-[120px] truncate"
                              title={log.hash}
                            >
                              {log.hash.slice(0, 12)}…
                            </code>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-muted-foreground ml-2">
                All entries are cryptographically linked. Export includes hash
